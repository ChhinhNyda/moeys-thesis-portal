...
export async function POST(req: Request) {
  ...
  // Public mode is open to anonymous visitors (the public catalogue).
  // Review mode is restricted to any authenticated user — without auth,
  // anyone could spoof mode=review and bypass the visibility check below.
  if (mode === "review") {
